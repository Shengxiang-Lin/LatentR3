...
for category in "CDs_and_Vinyl"; do
    ...
    for lr in 5e-5; do
        ...
        task_name=nomul_attn_group_lr_2_${lr}
        ...
        torchrun --nnodes=1 --nproc_per_node=2 --master_port=$((RANDOM % 9999 + 10000)) \
            src/grpo_attention_tuning_group/train_noise_grpo.py --category $category \
            ...
            --num_iterations 1 --epsilon 0.2 --epsilon_high 0.28 --num_groups 3\
        ...
        do
            ...
            python src/grpo_attention_tuning_group/noise_eval.py \
